<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAndRequest.aspx.cs" Inherits="LabControl.WebForm4" %>
	...
	<div class="contact">
		<div class="container">
			...
			<div class="form-horizontal">
                ...
                <br />
                    <div class="dropdown-menu-right">
                <asp:DropDownList ID="ddlLab" runat="server" DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="name" Width="710px" CssClass="form-control" >
                </asp:DropDownList>
                        </div>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LabControlConnectionString %>" SelectCommand="SelectNameLab" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </div>
                <div class="form-group">
                     Maquina de trabajo:<br />
                <br />
                    <div class="dropdown-menu-right">
                <asp:DropDownList ID="ddlWorkStation" runat="server" Width="710px" CssClass="form-control">
                </asp:DropDownList>
                <br />
                        </div>
                </div>

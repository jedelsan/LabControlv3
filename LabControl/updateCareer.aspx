<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateCareer.aspx.cs" Inherits="LabControl.WebForm1" %>
			...
			<div class="navigation">
				 <span class="menu"></span> 
					<ul class="navig">
                        ...
                        <li><a runat="server" href="~/AdminCareer" class="hvr-bounce-to-bottom">Atrás</a></li>
...
&nbsp;<!--start-contact-->
		...
		<p>Nombre:</p><input type="text" runat="server" class="form-control" id="txtName" />	
        <asp:Label ID="lblErrorNombre" runat="server" ForeColor="Red" Text="*Nombre no puede estar vacido" Visible="False"></asp:Label>

<br />
                <p>Descripcion:</p><input type="text" class="form-control"  runat="server" id="txtDesciption" />
                <asp:Label ID="lblErrorDescription" runat="server" ForeColor="Red" Text="*Correo no puede estar vacido" Visible="False"></asp:Label>
                <br />
				<p>Codigo:</p><input type="text" class="form-control" runat="server" id="txtCode" />

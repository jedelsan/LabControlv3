<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateUser.aspx.cs" Inherits="LabControl.signIn" %>
			...
			<div class="navigation">
				 <span class="menu"></span> 
					<ul class="navig">
                        ...
                        <li><a runat="server" href="~/Admin" class="hvr-bounce-to-bottom">Atrás</a></li>
...
&nbsp;<!--start-contact--><div class="contact">
        ...
        <asp:Label ID="lblErrorNombre" runat="server" ForeColor="Red" Text="*Nombre no puede estar vacío" Visible="False"></asp:Label>


     <br/>
              <p>Correo:</p><input type="text" class="form-control" runat="server" id="txtEmail" />
        <asp:Label ID="lblErrorCorreo" runat="server" ForeColor="Red" Text="*Correo no puede estar vacío" Visible="False"></asp:Label>
                <br />
				<p>Carnet:</p><input type="text" class="form-control"  runat="server" id="txtStudentId" />
                <asp:Label ID="lblErrorCarnet" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                <br />
                
       <p>Rol:</p><asp:DropDownList id="RolList" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="Selection_Change" runat="server">
                  ...
                  <asp:ListItem Value="4"> Profesor </asp:ListItem>
                    ...
                    <asp:Button type="button" ID="btnUpdate" runat="server" Text="Actulizar" CssClass="btn btn-success" OnClick="btnUpdate_Click1"   />
